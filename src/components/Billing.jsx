        ...
        >
            ...
            <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
                <h2 className={styles.heading2}>
                    Explore Our <br className="sm:block hidden" /> Digital
                    Creations
                </h2>
                <div className="w-full md:mt-0 mt-6">
                    ...
                    >
                        We craft engaging games and applications that run
                        smoothly on the Web3 platform, bringing new experiences
                        to users everywhere.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-wrap sm:justify-start justify-center w-full relative z-[1]">
                ...
                <div className="flex flex-col p-6 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feature-card">
                    <img
                        src={math}
                        alt="Math Game"
                        className="w-full h-auto rounded-[10px] object-cover mb-5"
                    />
                    ...
                    <p className="font-poppins font-normal text-dimWhite text-[16px] leading-[24px] mb-4">
                        Test your speed and accuracy by solving math problems in
                        our exciting Telegram mini-game.
                    </p>
                    <a
                        ...
                        className="mt-auto"
                    >
                        <Button text="Play Math Battle" styles="mt-10" />{" "}
                    </a>
                </div>
                ...
                <div className="flex flex-col p-6 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feature-card">
                    ...
                    <p className="font-poppins font-normal text-dimWhite text-[16px] leading-[24px] mb-4">
                        Memorize the sequence of colors and repeat it to score
                        high in this addictive mini-game.
                    </p>
                    <a
